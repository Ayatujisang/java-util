package com.kk.netty4.http.helloworld;
...
/**
 * 默认是 DefaultHttpRequest
 */
public class SimpleFileServerHandler extends SimpleChannelInboundHandler<DefaultHttpRequest> {
