...
public class UserAgentUtil {
    ...
    private static UserAgent judgeBrowser(String userAgent,
        ...
        if (userAgent.contains("Chrome")) {
            ...
            return new UserAgent("Chrome", chromeVersion, platformType,
            ...
            return new UserAgent("Firefox", ffVersion, platformType,
                    platformSeries, platformVersion);
            ...
            if (userAgent.contains("MSIE 10.0")) {// Internet Explorer 10
                return new UserAgent("Internet Explorer", "10", platformType,
                        platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 9.0")) {// Internet Explorer 9
                return new UserAgent("Internet Explorer", "9", platformType,
                        platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 8.0")) {// Internet Explorer 8
                return new UserAgent("Internet Explorer", "8", platformType,
                        platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 7.0")) {// Internet Explorer 7
                return new UserAgent("Internet Explorer", "7", platformType,
                        platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 6.0")) {// Internet Explorer 6
                return new UserAgent("Internet Explorer", "6", platformType,
                        platformSeries, platformVersion);
            }
        } else {// 暂时支持以上三个主流.其它浏览器,待续...
            return new UserAgent(null, null, platformType, platformSeries,
                    platformVersion);
        }
        return null;
    }

    private static final String pattern_ua_android = ".*android[\\s\\/_]*([2-9][\\._][0-9][0-9_\\.]*).+(?i)webkit.*";

    private static final String patter_ua_iphone = ".*os [3-9]_.*";

    private static final String pattern_ua_qq_browser_android = ".*mqqbrowser.*adr.*";

    private static final String pattern_ua_qq_browser_ios = ".*mqqbrowser.*os.*";

    private static final String pattern_ua_htc_flyerPad = ".*(htc[_a-zA-Z0-9]+)[;\\s]*.webkit.*";

    private static final String patter_ua_opera = ".*android.*opera.*";

    private static final String patter_ua_ucweb_android = ".*ucweb.*adr.*";

    private static final String patter_ua_ucweb_ios = ".*iuc.*ios.*";

    private static final String patter_ua_sogou_android = ".*android.*sogoumobile.*";

    private static final String patter_ua_sogou_ios = ".*os.*sogoumobile.*";

    private static final String patter_ua_htc_uc_android = ".*htc.*ucweb.*";

    private static final String patter_ua_firefox_android = ".*android.*firefox.*";

    private static final String patter_ua_360hd_android = ".*360browser.*";

    /**
     * 是否是android类型
     *
     * @param userAgent 都是小写字母
     * @return
     */
    public static boolean isAndroid(String userAgent) {
        if (userAgent.matches(pattern_ua_android)
                || userAgent.matches(pattern_ua_htc_flyerPad)
                || userAgent.matches(pattern_ua_qq_browser_android)
                || userAgent.matches(patter_ua_opera)
                || userAgent.matches(patter_ua_ucweb_android)
                || userAgent.matches(patter_ua_sogou_android)
                || userAgent.matches(patter_ua_htc_uc_android)
                || userAgent.matches(patter_ua_firefox_android)
                || userAgent.matches(patter_ua_360hd_android)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isIos(String userAgent) {
        if (userAgent.matches(patter_ua_iphone)
                || userAgent.matches(pattern_ua_qq_browser_ios)
                || userAgent.matches(patter_ua_ucweb_ios)
                || userAgent.matches(patter_ua_sogou_ios)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isWap(String userAgent) {
