...
public class JodaTimeUtil {
    ...
    public static void main(String[] args) {
        {
            // 当前小时
            System.out.println(LocalTime.now().getHourOfDay());
            // 当前分钟
            System.out.println(LocalTime.now().getMinuteOfHour());
            // 当前秒
            System.out.println(LocalTime.now().getSecondOfMinute());
            // 当前time， 时分秒
            System.out.println(LocalTime.now()); // 19:10:47.437
        ...
        }
        {
            ...
            // 相加两个小时
            System.out.println(time.plusHours(2).toDate());

            // 减去一天
            System.out.println(time.minusDays(1).toDate());
            System.out.println(time.plusDays(-1).toDate());

            System.out.println("--------------------------------------");
        }
        {
            // 初始化Datetime
            DateTime dateTime = new DateTime(2000, 2, 1, 0, 0, 0, 0);
            System.out.println(dateTime);

            // 日期， 年月日
            LocalDate localDate = dateTime.toLocalDate();
            System.out.println(localDate); // 2000-02-01

            // 时间 ，时分秒
            LocalTime localTime = dateTime.toLocalTime();
            System.out.println(localTime); // 00:00:00.000

            // 增加90天 格式化
            System.out.println(dateTime.plusDays(90).toString(
                    "E MM/dd/yyyy HH:mm:ss.SSS"));
            ...
            // 日期格式化
            System.out
                    .println(dateTime.toString(ISODateTimeFormat.yearMonth()));
        ...
        }
        {
            ...
            // 时间解析 根据指定格式,将时间字符串转换成DateTime对象,这里的格式和上面的输出格式是一样的
